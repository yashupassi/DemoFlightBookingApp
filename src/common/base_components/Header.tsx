...
function Header ({ label, leftPress, rightPress, rightLabel, showRightIcon, iconRight, iconLeft, children, backgroundColor=Colors.white }: HeaderInterface){
    ...
    return (
        <WRow padding={[0, Utils.scaleSize(10)]} style={container} dial={5} backgroundColor={backgroundColor}>
            {leftIcon}
            <WView flex dial={5}>
                <WRow dial={5}>
                    {children}
